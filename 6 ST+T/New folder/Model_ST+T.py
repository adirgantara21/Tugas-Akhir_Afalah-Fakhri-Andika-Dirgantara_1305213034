...
Melatih model...
Pelatihan selesai.
Model disimpan sebagai: models/mi_ST+T.pkl

Classification Report:
              precision    recall  f1-score   support

        NORM       0.62      0.86      0.72      4671
         IMI       0.70      0.43      0.53      4715
         AMI       0.43      0.20      0.28       648
         PMI       1.00      0.10      0.18        30
         LMI       0.36      0.21      0.26       277
        ASMI       0.59      0.63      0.61      3757
        ILMI       0.25      0.43      0.31       801
        ALMI       0.74      0.24      0.36       327
        IPMI       1.00      0.09      0.16        56
       IPLMI       0.86      0.12      0.21        99

    accuracy                           0.59     15381
   macro avg       0.66      0.33      0.36     15381
weighted avg       0.61      0.59      0.57     15381


Confusion Matrix:
Actual \ Pred NORM     IMI     AMI     PMI     LMI    ASMI    ILMI    ALMI    IPMI    IPLMI
NORM         4038     254     30       0      17      217     112      3       0       0
IMI          1306    2011     64       0      24      866     435      8       0       1
AMI           242     67      131      0       9      135     64       0       0       0
PMI            5       7       3       3       1       5       6       0       0       0
LMI           87      18       4       0      58      81      29       0       0       0
ASMI          647     317     59       0      44     2379     297     14       0       0
ILMI          95      154      4       0       3      197     346      1       0       1
ALMI          51      17       6       0       3      95      77      78       0       0
IPMI          10      19       0       0       1      10      10       1       5       0
IPLMI         19      26       2       0       1      14      25       0       0      12
...
Contoh: Prediksi dengan model yang dimuat kembali
Model berhasil dimuat dari: models/mi_ST+T.pkl

Sample Predictions vs Actual:
- Sample 1: Predicted = NORM  | Actual = IMI   --> ❌ SALAH
...
- Sample 5: Predicted = ASMI  | Actual = ASMI  --> ✅ BENAR